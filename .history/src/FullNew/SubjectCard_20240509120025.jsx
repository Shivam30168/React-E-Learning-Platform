...
const SubjectCard = () => {
  ...
  function checkData() {
    const foundProduct = products.find(item => item.title === param.subject);
     foundProduct ? setAllData({title:foundProduct.title,thumbnail:foundProduct.thumbnail}) : "No data";
  }
  return (
    ...
    <Card style={{ width: '20rem' }} className='card'>
      ...
      <Card.Body>
        {products && products.length ? allData.title : "no data"}
        <Card.Text>
    ...
    <Card style={{ width: '20rem' }} className='card'>
      <Card.Img variant="top" src={allData.title}/>
      <Card.Body>
